...
### 🕸️ Immersive Visuals
* **Three.js Background:** An interactive 3D network of floating nodes and connections that reacts to mouse movement and scrolling.
* **Matrix Rain:** A classic digital rain effect overlaid on the canvas.
* **Glassmorphism:** "Tilt" cards that respond to 3D hover effects using CSS transforms.
* **Glitch Effects:** CSS-based text glitch animations on the hero section.
...
| **CSS3** | Animations, Grid/Flexbox, Glassmorphism variables |
| **JavaScript (ES6)** | DOM manipulation, Logic, Canvas rendering |
| **Three.js** | 3D Node network and particle rendering |
| **Font Awesome** | Iconography |
| **Google Fonts** | Typography (Rajdhani & Share Tech Mono) |
...
3.  **Launch**
    Simply open the `index.html` file in your preferred browser (Chrome, Firefox, or Edge recommended for best performance).
